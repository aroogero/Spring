...
import java.util.Set; //у Сет-а данные не дублируются
...
public class ShopItem {  //а в нашем классе он будет называться ShopItem - а у меня так
    ...
    @ManyToMany
    private Set<ShopMarket> markets; //множество Сет - отличается от списка Листа тем, что там дублироваться данные физически не могут
}
